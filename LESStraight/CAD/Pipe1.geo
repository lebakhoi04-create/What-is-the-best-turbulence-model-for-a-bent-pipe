...
//+
Transfinite Curve {21, 13, 20, 18, 15, 11, 16, 14} = 45 Using Progression 1;
//+
Transfinite Curve {10, 17, 19, 12} = 24 Using Progression 1;
//+
...
//+
Extrude {0, 0, 1.04/2} {
  Surface{5}; Surface{3}; Surface{2}; Surface{4}; Surface{1}; Layers {200}; Recombine;
}
//+
