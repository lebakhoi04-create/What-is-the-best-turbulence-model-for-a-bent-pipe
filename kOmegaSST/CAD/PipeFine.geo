...
//+
Transfinite Curve {28, 36, 33, 35, 29, 26, 31, 30} = 25 Using Progression 1;
//+
Transfinite Curve {27, 25, 32, 34} = 28 Using Progression 0.83333333;
//+
...
//+
Extrude {0, 0, 1.04} {
  Surface{5}; Surface{3}; Surface{4}; Surface{2}; Surface{1}; Layers {103}; Recombine;
}
//+
Extrude {{-1, 0, 0}, {0, 0.208, 9.36}, Pi/2} {
  Surface{17}; Surface{10}; Surface{14}; Surface{20}; Surface{22}; Layers{120}; Recombine;
}
//+
Extrude {0, 0.104*40, 0} {
  Surface{31}; Surface{27}; Surface{39}; Surface{37}; Surface{34}; Layers {640}; Recombine;
}
//+
